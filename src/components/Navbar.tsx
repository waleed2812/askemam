...
export const Navbar: React.FC<any> = () => {
  ...
  return (
    <div className="bg-secondary text-white absolute top-0 left-0 w-full h-20 px-2 py-5 flex items-center justify-center">
      <div className="w-full h-full container flex justify-between items-center text-2xl ">
        <div>
          <h1 className="font-helvetica">AskEMAM</h1>
        </div>
        <div>
          <button
